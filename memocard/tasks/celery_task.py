...
from memocard.api import notion_api
from memocard.api import github_api
from memocard.api.jianguoyun_api import JianGuoYunClient
from memocard.api.jianguoyun_api import jianguoyun_clients
...
celery.conf.beat_schedule = {
    'run-every-12*60*60-seconds': {
        'task': 'memocard.tasks.celery_task.time_task',
        'schedule': 12*60*60
    },
   'time_get_diary_log_task': {
   'task': 'memocard.tasks.celery_task.time_get_diary_log_task',
   'schedule': 1*60*60
   }
}
